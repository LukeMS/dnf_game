...
from dnf_main.components.combat import char_roll, creatures
from util import get_mod_case, packer
from util.rect import Rect
from scene_manager.scenes.base_scenes import SceneMultiLayer
from scene_manager.layers.base_layers import Layer
from util.sftext import SFText
...
if __name__ == '__main__':
    ...
    g = Manager(scene=SceneCreation).execute()
