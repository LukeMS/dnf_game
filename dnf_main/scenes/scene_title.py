...
from scene_manager.layers.base_layers import Menu, ScrollingSubtitle
from dnf_main.scenes import scene_descriptions, scene_creation, scene_map
...
class SceneTitle(SceneMultiLayer):
    ...
    def create_items(self):
        ...
        if not os.path.isdir(os.path.join(WP, 'save')):
            # os.makedirs('save')
            self._menu.pop(2)
