...
class LogicLayer(EntityBase):
    ...
    def __new__(cls, *, parent, **kwargs):
        ...
        if not isinstance(parent, EntityBase):
            raise TypeError("parent must EntityBase")
...
class Msg(Layer):
    ...
    def draw(self):
        ...
        if self.text_rendered != text or not self.sprites:
            ...
            msg_shadow_sfc = render(text, color=GAME_COLORS["gray"])
...
class Inventory(Layer):
    ...
    def __init__(self, parent):
        ...
        self.offset = 0
        self.inv_render = []
        self.fonts = parent.manager.fonts
    ...
    def create_head(self):
        ...
        head_title_shadow_sfc = head_font.render(
            "< Inventory >", color=GAME_COLORS["black"])
    ...
    def set_inventory(self, holder, target=None, mode="use"):
        ...
        for i, item in enumerate(self.inventory[offset:offset + limit]):
            ...
            txt_shd_sfc = main_font.render(text, color=GAME_COLORS["black"])
...
class Bar(Layer):
    ...
    def __init__(self, parent, name, alpha=90):
        ...
        self.color_table = LBPercentTable(
            ...
            table=(
                (0, (223, 0, 0, 192)),  # red
                (25, (*GAME_COLORS["yellow"][:3], 176)),
                (50, (*GAME_COLORS["lime"][:3], 160)),
                (75, (*GAME_COLORS["green"][:3], 144))
            )
        )
